...
import {
  ...
  useConvexAuth,
  useQuery
} from "./chunk-7YPCTXUV.js";
import "./chunk-DOA7R4DY.js";
import {
  require_react
...
function ConvexBetterAuthProvider({ children, client, authClient, initialToken }) {
  ...
  (0, import_react.useEffect)(() => {
    (async () => {
      var _a, _b;
      if (typeof window === "undefined" || !((_a = window.location) == null ? void 0 : _a.href)) {
        return;
      }
  ...
  return (0, import_react.useMemo)(() => function useAuthFromBetterAuth() {
    ...
    return (0, import_react.useMemo)(
      () => ({
        ...
        isAuthenticated: Boolean(session == null ? void 0 : session.session) || cachedToken !== null,
        fetchAccessToken
      }),
      // eslint-disable-next-line react-hooks/exhaustive-deps
